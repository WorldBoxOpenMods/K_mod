...
namespace K_mod
{
    class NewGodPowers
    {
        ...
        public static bool action_spawn2(WorldTile pTile, string pPowerID)
        {
        ...
        public static void initPowers()
        {
            ...
            GodPower Ballistapower = AssetManager.powers.clone("spawn_Ballista", "_spawnActor");
            Ballistapower.name = "spawn_Ballista";
            Ballistapower.actor_asset_id = "Ballista";
            Ballistapower.click_action = new PowerActionWithID(action_spawn2);
            AssetManager.powers.add(Ballistapower);

            GodPower Catapultpower = AssetManager.powers.clone("spawn_Catapult", "_spawnActor");
            Catapultpower.name = "spawn_Catapult";
            Catapultpower.actor_asset_id = "Catapult";
            Catapultpower.click_action = new PowerActionWithID(action_spawn2);
            AssetManager.powers.add(Catapultpower);
